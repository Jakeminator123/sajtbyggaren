...
COMMON_WORDS = {
    ...
    # PR #68 restaurant-hospitality soft Dossier examples: component names,
    # schema.org names, vendor names and fixture day labels used in
    # instructions/manifest examples. They are local implementation/example
    # symbols for declarative Dossiers, not new Sajtbyggaren canonical terms.
    "AggregateRating", "Answer", "Bokadirekt", "BookEden",
    "BookingCta", "BookingCtaProps", "BookingDestination", "BookingHours",
    "Calendly", "Caspeco", "Closed", "DirectionsLink", "FAQPage",
    "FaqAccordion", "FaqAccordionProps", "FaqGroup", "FaqItem",
    "FormEvent", "GalleryImage", "ImageGallery", "ImageGalleryProps",
    "MailtoContactForm", "MailtoContactFormProps", "MapAddress", "MapEmbed",
    "MapEmbedProps", "MenuDisplay", "MenuDisplayProps", "MenuSection",
    "OpenStreetMap", "OpeningHoursDay", "OpeningHoursProps",
    "OpeningHoursSpan", "OpeningHoursSpecification", "PricingFeature",
    "PricingTable", "PricingTableProps", "PricingTier", "Question",
    "Resmio", "Review", "ReviewCard", "ReviewItem", "ReviewSource",
    "ReviewsDisplay", "ReviewsDisplayProps", "SendGrid", "Tis", "Tisdag",
    "TripAdvisor", "VideoHero", "VideoHeroOverlay", "VideoHeroProps",
    "VideoHeroSource", "YouTube",
