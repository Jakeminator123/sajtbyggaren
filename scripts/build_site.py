...
def render_home(
    ...
    *,
    ...
    # Hero-bild från operatör-upload (om finns) renderas i toppen av
    # första sektionen. Bilden ligger redan i public/uploads/ via
    # copy_operator_uploads. Vi använder raw <img> (inte next/image)
    # eftersom webp:erna är pre-komprimerade av sharp och starters har
    # ingen Next.js Image-loader-konfig att lita på.
    brand_block = dossier.get("brand") if isinstance(dossier.get("brand"), dict) else {}
...
def render_about(dossier: dict) -> str:
    ...
    # Bilderna kommer från operatör-upload via copy_operator_uploads.
