...
def main() -> int:
    ...
    # Opt-in maintenance pass: prune old runs/uploads per .env caps before
    # the new run lands on disk. Failures are swallowed so a broken
    # auto-prune never blocks an operator's build (B30-style).
    try:
