...
last_verified_commit: 25250a46
---

# Arkiv: stängda buggar + Round 1 audit-narrativ (utbrutet ur known-issues.md)

> **Arkiv = historik, inte sanningskälla; verifiera mot git/koden.** Stängda
> buggar bevaras här med sina test-referenser. För aktivt bug-scope + de
> senaste stängda buggarna: [`docs/known-issues.md`](../known-issues.md). Kör
> `python scripts/list_open_bugs.py` för den levande listan.

Utbrutet 2026-06-15 ur `docs/known-issues.md` som ren registerhygien (ingen
omklassning av buggar). Innehållet är kopierat ordagrant - B-ID, severity,
Fix-SHA och Test-referenser är oförändrade. Två block flyttades hit:

1. Round 1 audit-narrativet (historisk prosa som låg före Öppna-rubriken och
   som scripts/list_open_bugs.py aldrig läste).
2. De 159 äldsta stängda buggarna (stängda 2026-05-08 till 2026-06-10). De 15
   senaste stängda buggarna ligger kvar i den levande listan.
...
## Stängda buggar - arkiverade (stängda 2026-05-08 till 2026-06-10)
