...
last_verified_commit: 54055fc
---

# Post-build-plan — när hela kör-sekvensen är implementerad

> **Arkivnot (docs-honesty-pass 2026-06-12):** Historisk plan från
> 2026-06-04. Flyttad från `docs/heavy-llm-flow/post-build-plan.md` eftersom
> dess aktiva statusblock säger att `/api/prompt` inte är wirad, att kor-5
> repair är dormant och att hostad `/api/prompt` fortfarande stoppas av 501.
> De påståendena är historiska mot dagens kod. Nuläget finns i
...
- **Baseline-eval:** 4 prompter genom riktig preview. Avgör om det
