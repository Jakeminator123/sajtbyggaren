...
last_verified_commit: a2ffa05
---

# Orchestrerings-handoff — heavy-llm-flow

> **Arkivnot (docs-honesty-pass 2026-06-12):** Historisk handoff från
> 2026-06-03. Flyttad från `docs/heavy-llm-flow/handoff-orchestration.md`
> eftersom den aktiva texten påstod att follow-up-bryggan inte var inkopplad
> i någon användarväg. Det var sant då, men är falskt mot dagens kod: OpenClaw
> apply-bryggan körs via `/api/prompt` både lokalt och hostat. Nuläget finns i
> `docs/heavy-llm-flow/README.md`; arkivet är inte sanningskälla.
...
| `eb68028` · `caf9a71`/`6a8e39b` | #155 KÖR-0 · hosting-roadmap + preview-loop-kärna |
...
- **Vercel-adapter-härdning** (apps/viewser, live-lane): historisk P2-not om adapter-reconnect. Ej blocker.
...
- **Lokal evals-dir-env** (operatörens lokala miljö): historisk not om att ett
  lokalt override gjorde evals-dir-testet rött i full-sviten. För helgrön svit
  använd repo-defaulten. (Worktree-builders ärvde inte root-miljön → de var gröna.)
