...
last_verified_commit: 0c89942
---

# Handoff-historik (utbruten 2026-06-09)

> **Arkiv = historik, inte sanningskälla.** Detta är historiken som låg under
> historiklinjen i `docs/handoff.md`, utbruten i steward-passet 2026-06-09 så
> handoff-toppen blir snabb att läsa. För nuläget: `docs/handoff.md` toppblock +
> [`docs/current-focus.md`](../../current-focus.md). Verifiera alltid mot git/koden,
> aldrig mot ett arkiverat block (deras SHA är pre-sync och stale). Se
...
# ARKIVERAT 2026-06-10: handoff-toppblock 2026-06-08 (ersatt av nattens 15-PR-block)
...
> `governance/rules/04-branch-and-team.md`.
