# ARKIV: current-focus.md (snapshot före slimning 2026-06-08)

> **Detta är en arkiverad ögonblicksbild** av `docs/current-focus.md` precis
> innan den slimmades enligt `governance/rules/current-focus-hygiene.md`
> (2026-06-08). Den är **historik** — verifiera alltid mot git och mot den
> aktuella `docs/current-focus.md`, aldrig mot detta block. Sparad för att
> "flytta, inte radera" gamla statusblock.
...
### 2026-06-05 UTC — current-focus.md före `cc7ddc8`
