...
post-sprint-`main` (`54cbdca`)** för att verifiera att Builder-sprint
2026-05-21 (`bfcdba4` → `54cbdca`) faktiskt löser fynden i renderad
...
i `bfcdba4` → `54cbdca`:** B137 (wizard-overlay tagline-sanering),
