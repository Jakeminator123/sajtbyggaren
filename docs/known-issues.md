...
> **Aktivt bug-scope:** 19 aktiva, 15 misplaced (har Fix-SHA men borde flyttas till Stängda), 4 unknown, 48 stängda. Kör `python scripts/list_open_bugs.py` för full lista. Format-disciplin: se governance/rules/bug-scope-discipline.md.
