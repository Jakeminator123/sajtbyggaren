...
**Stash-läge:** `stash@{0}` finns kvar men är nu stale för B56 (fixen är redan integrerad i `8fae26a` på `main`). Behåll endast om du vill jämföra historik; annars kan stashen droppas säkert.
