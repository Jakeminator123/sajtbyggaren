...
**Aktuell repo-HEAD på `main`:** `54cbdca` (`feat(planning): add intentGuardWarnings light (warning-only)`, 2026-05-21, Builder-sprint B137+B138+IntentGuard).
