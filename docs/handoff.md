...
Se `docs/current-focus.md` → **"Next action"**. Kort version: B121 PR A (#34, `70c261b`) och PR B (#35, `ec32913`) är mergade. Nästa feature-spår är **PR C — Backoffice Discovery Control** så Backoffice "hänger med" discovery-resolvern. PR D (baseline-smoke) och formell B121-stängning kommer efter PR C.
