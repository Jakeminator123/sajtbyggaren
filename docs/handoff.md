...
Se `docs/current-focus.md` → **"Next action"**. Kort version: B121 PR A (#34, `70c261b`), PR B (#35, `ec32913`) och PR C (#36, `89680fa`) är mergade. Nästa är **Prompt 5 — Scout read-only audit** av hela discovery-kedjan (overlay → taxonomy → resolver → Project Input → Backoffice). PR D (baseline-smoke) och formell B121-stängning kommer efter Scout-go.
