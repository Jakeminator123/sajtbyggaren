...
`christopher`, och PR mot `main` öppnas när en ny officiell version
ska in. (`christopher-ui` är fryst legacy och tas in långt senare — se
`governance/rules/christopher-active-branch.md`.) Hitta inte på egna
branch-prefix utöver `cursor/<syfte>` för tillfälliga feature-branches.
