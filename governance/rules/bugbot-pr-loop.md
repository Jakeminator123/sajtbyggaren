...
4. Kör Standard loop steg 8 som mainline-steward-commit på `main`:
...
- `docs/agent-handbook.md` Standard loop steg 2 + 6 + 8 — denna
  regel är operationaliseringen av steg 2 (Ro-review = Bugbot på
  PR), steg 6 (merge) och steg 8 (post-merge bump) för PR-flödet.
