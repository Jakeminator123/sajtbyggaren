...
- Den här regeln är den auktoritativa källan för Christopher-lanens
  branch-val. [`branch-discipline.md`](branch-discipline.md) och
  [`team-workflow.md`](team-workflow.md) pekar på samma `christopher`.
  `christopher-ui` tas in långt senare, först på operatörens uttryckliga
  beslut.
