...
- [0063 hard Starter-kontrakt](0063-hard-starter-kontrakt.md) — Starter = layout-skal, aldrig build_site.py-special; formaliserar "Hårda krav per starter" + anslutningsregeln mot dispatchern (Path B) + varningssignalen
