# ADR 0002: Backoffice som `backoffice.py` Streamlit, separat från runtime
...
- Sajtbyggaren har en enda backoffice-startpunkt: `backoffice.py` i repo-roten (Streamlit-app).
...
- Naming-dictionary listar `Backoffice` som kanonisk term med `ownerPackage: backoffice.py`.
