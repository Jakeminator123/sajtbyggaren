...
_SYSTEM_INSTRUCTIONS = (
    ...
    "CRITICAL - one_liner, differentiator, audience_need and local_angle are rendered "
    "VERBATIM as customer-facing copy (the hero headline/subheadline, the 'Om oss' story "
    "and the FAQ), so write each as a short, ready-to-read phrase IN THE PROMPT'S LANGUAGE "
    "that speaks to the visitor about the business. Never write them as an instruction "
    "about the copy: do NOT reference the website's construction ('copy', 'the hero', 'the "
    "contact section', 'kontaktsektion', 'CTA', 'subheadline'), do NOT use an imperative "
    "directive verb ('Lyft fram ...', 'Framhäv ...', 'Betona ...', 'Visa ...'), and do NOT "
    "use should/'bör'/'ska'-style phrasing about what the copy ought to do. Write 'Kafé "
    "Solrosen i Göteborg - lokala bönor och nybakat varje morgon', never 'Lyft Kafé "
    "Solrosen som ...' or 'Göteborg bör synas tydligt i copy'. "
