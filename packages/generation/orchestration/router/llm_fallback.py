...
_SYSTEM_INSTRUCTIONS = (
    ...
    "layout_change, route_add, route_remove) and 'none' otherwise. route_remove "
    "is removing a WHOLE existing page ('ta bort sidan Om oss', 'radera "
    "kontaktsidan'); removing only a link or menu item is component_remove, not "
    "route_remove. "
