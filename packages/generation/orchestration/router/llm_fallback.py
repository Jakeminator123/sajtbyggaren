...
_SYSTEM_INSTRUCTIONS = (
    ...
    "(component_add, component_remove, section_add, visual_style, copy_change, "
    "layout_change, route_add, route_remove, nav_hide) and 'none' otherwise. "
    "route_remove is removing a WHOLE existing page ('ta bort sidan Om oss', "
    "'radera kontaktsidan'). nav_hide is hiding only a page's NAV LINK while "
    "keeping the page ('dölj Om oss i menyn', 'ta bort Om oss ur menyn', 'ta "
    "bort länken till Kontakt') - use it when a named page's link/menu entry is "
    "targeted; a link/menu removal that names no page is component_remove. "
